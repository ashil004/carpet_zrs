...
import Grassdetels from "./Grassdetels";
...
const Grass = () => {
    const [agrass, setAgrass] = useState([]);
    useEffect(() => {
        fetch('https://test.zrsflooring.com/grass')
            .then(res => res.json())
            .then(data => setAgrass(data));
    ...
    return (
        <div>
            ...
            <div>
                <div className="-mt-24">
                    <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/p3bL4Jb/Artificial-Grass-Slider-Image.webp)', }}>
                        <div className="hero-overlay"></div>
                        <div className="  text-white -mt-56 ml-12 ">
                            <h1 className="text-3xl font-bold" >Artificial Grass</h1>
                            <p>We Are The Best Artificial grass suppliers in UAE</p>
                        </div>
                    </div>
                ...
                <div className="flex  mt-10  space-x-6 m-6 ">
                    ...
                    <div className="w-[95%] xl:w-[98%] lg:w-[90%] mx-auto xl:gap-8 lg:gap-6 md:gap-10 gap-2 grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 my-12 ">

                        {
                            agrass.map(agras => <Grassdetels key={agras._id} agras={agras}></Grassdetels>)
