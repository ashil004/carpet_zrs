...
const Deckdeitls = ({ adeck }) => {
    const { pic, title,desception } = adeck
    return (
        <div className="xl:w-[1170px] mx-auto">
           <div className="card lg:card-compact  bg-white shadow-xl">
                <figure><img className="xl:w-full  lg:w-full  md:w-[600px] md:h-96 w-96 h-96" src={pic}  /></figure>
