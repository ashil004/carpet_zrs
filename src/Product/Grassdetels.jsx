...
const Grassdetels = ({ agras }) => {
    const { pic, title, desception } = agras;
    return (
        <div className="xl:w-[1170px] mx-auto">

            <div className="card lg:card-compact   bg-white shadow-xl">
                <figure><img className="xl:w-full xl:h-[650px]  lg:w-full  md:w-[600px] md:h-96 w-96 " src={pic} /></figure>
