...
const Wallproductuplode = () => {
    const wall = async event => {
    ...
    return (
        ...
        <h3 className="text-center text-2xl font-semibold text-lime-500">Wall Product</h3>
        <div className="flex justify-between items-center ">
        <div className="dropdown">
                        <div tabIndex={0}  className="btn m-1"><button className=" text-sm md:text-lg ">Wall Sub <span className="hidden md:inline">Product </span> </button></div>
                        <ul tabIndex={0} className="dropdown-content z-[1] menu p-2 shadow bg-white rounded-box w-52">
                            <li><Link className="text-sm md:text-lg hover:text-lime-400" to="">WPC Co Extrusion  </Link></li>
                            <li><Link className="text-sm md:text-lg hover:text-lime-400" to="">WPC OD </Link></li>
                            <li><Link className="text-sm md:text-lg hover:text-lime-400" to="">PVC Square Hollow </Link></li>
                            <li><Link className="text-sm md:text-lg hover:text-lime-400" to="">PVC Round Hollow </Link></li>
                            <li><Link className="text-sm md:text-lg hover:text-lime-400" to="">PVC Solid </Link></li>
                            <li><Link className="text-sm md:text-lg hover:text-lime-400" to="">Wall Acrylic Sheet</Link></li>
                            <li><Link className="text-sm md:text-lg hover:text-lime-400" to="">PU STONE</Link></li>
                            <li><Link className="text-sm md:text-lg hover:text-lime-400" to=""> Accessories</Link></li>
                        </ul>
                    </div>
                <Link to='/admin/wall-edit'><button className="btn  text-sm md:text-lg ">Edit Product</button></Link>
            </div>
    <form onSubmit={wall} >
...
export default Wallproductuplode;