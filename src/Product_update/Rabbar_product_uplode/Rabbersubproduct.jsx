...
const Rabbersubproduct = () => {
    const subproduct = async event => {
        ...
        fetch('https://test.zrsflooring.com/rabber-sub-product', {
            method: 'POST',
            headers: {
    ...
    return (
        <div className="xl:ml-[32%] xl:mt-[4%] lg:ml-[22%] lg:mt-[4%] md:mt-6 md:ml-[13%] ml-[1%] mt-4">
            <h3 className="text-center text-xl font-semibold text-lime-500"> Rubber SubProduct</h3>
...
export default Rabbersubproduct;