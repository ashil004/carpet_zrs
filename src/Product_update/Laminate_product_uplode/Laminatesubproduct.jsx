...
const Laminatesubproduct = () => {
    const subproduct = async event => {
        ...
        fetch('https://test.zrsflooring.com/laminate-sub-product',{
            method:'POST',
            headers:{
    ...
    return (
        ...
        <h3 className="text-center text-xl font-semibold text-lime-500"> Laminate SubProduct</h3>
        <form onSubmit={subproduct} >
            <div className="form-control">
                <label className="label">
                    <span className="label-text text-blue-800 font-bold "> Sub Product Title</span>
                </label>
            ...
            <div className="form-control">
                <label className="label">
                    <span className="label-text text-blue-800 font-bold "> Sub Product Photo:</span>
                </label>
            ...
            <div className="form-control mt-6 ">
                <button className="btn order-blue-400 rounded-lg bg-blue-800  text-white hover:bg-lime-500">SubProduct Upload!</button>
...
export default Laminatesubproduct;