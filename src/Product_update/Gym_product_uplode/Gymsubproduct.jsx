...
const Gymsubproduct = () => {
    const subproduct = async event => {
        ...
        fetch('https://test.zrsflooring.com/gym-sub-product',{
            method:'POST',
            headers:{
    ...
    return (
        ...
        <h3 className="text-center text-xl font-semibold text-lime-500">Gym  SubProduct</h3>
