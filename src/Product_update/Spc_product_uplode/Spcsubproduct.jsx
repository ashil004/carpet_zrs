...
const Spcsubproduct = () => {
    const subproduct = async event => {
        ...
        fetch('https://test.zrsflooring.com/spc-sub-product',{
            method:'POST',
            headers:{
    ...
    return (
        ...
        <h3 className="text-center text-xl font-semibold text-lime-500"> Spc SubProduct</h3>
