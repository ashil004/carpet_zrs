...
const Spcproductuplode = () => {
    const spc = async event => {
        ...
        console.log(vip);
        fetch('https://test.zrsflooring.com/spc',{
            method:'POST',
            headers:{
    ...
    return (
        <div className="xl:ml-[32%] xl:mt-[4%] lg:ml-[22%] lg:mt-[4%] md:mt-6 md:ml-[13%] ml-[8%] mt-4">
            <h3 className="text-center text-2xl font-semibold text-lime-500">Spc Product</h3>
            <div className="flex justify-between items-center ">
            <div className="dropdown">
                        <div tabIndex={0}  className="btn m-1"><button className=" text-sm md:text-lg ">Spc Sub <span className="hidden md:inline">Product </span></button></div>
                        <ul tabIndex={0} className="dropdown-content z-[1] menu p-2 shadow bg-white rounded-box w-52">
                            <li><Link className="text-sm md:text-lg hover:text-lime-400" to="">Falcon Eva </Link></li>
                            <li><Link className="text-sm md:text-lg hover:text-lime-400" to="">Camel </Link></li>
                            <li><Link className="text-sm md:text-lg hover:text-lime-400" to="">Higher Eva </Link></li>
                            <li><Link className="text-sm md:text-lg hover:text-lime-400" to="">Higher </Link></li>
                            <li><Link className="text-sm md:text-lg hover:text-lime-400" to="">Herringbone </Link></li>
                            <li><Link className="text-sm md:text-lg hover:text-lime-400" to="">Herringbone Eva </Link></li>
                            <li><Link className="text-sm md:text-lg hover:text-lime-400" to="">Stone </Link></li>
                            <li><Link className="text-sm md:text-lg hover:text-lime-400" to="">Accessories</Link></li>
                        </ul>
                    </div>
                    <Link to='/admin/spc-edit'><button className="btn  text-sm md:text-lg ">Edit Product</button></Link>
                </div>
        <form onSubmit={spc} >
...
export default Spcproductuplode;