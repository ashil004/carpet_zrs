...
const Lvteditdetils = ({data , hendelDelete}) => {
             ...
             <div className="card lg:card-side bg-white shadow-xl">
                ...
                <div className="card-body">
                    ...
                    <div className="card-actions justify-end">
                        <Link to={`/admin/lvt-upload-product`}><button className="btn btn-outline btn-accent">Edit</button></Link>
