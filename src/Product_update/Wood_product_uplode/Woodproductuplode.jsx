...
const Woodproductuplode = () => {
    const wood = async event => {
        ...
        console.log(vip);
        fetch('https://test.zrsflooring.com/wood',{
            method:'POST',
            headers:{
    ...
    return (
        ...
        <h3 className="text-center text-2xl font-semibold text-lime-500">Wood Product</h3>
        <div className="flex justify-between items-center ">
        <div className="dropdown">
                        <div tabIndex={0}  className="btn m-1"><button className=" text-sm md:text-lg ">Wood Sub <span className="hidden md:inline">Product </span></button></div>
                        <ul tabIndex={0} className="dropdown-content z-[1] menu p-2 shadow bg-white rounded-box w-52">
                            <li><Link className="text-sm md:text-lg hover:text-lime-400" to="/admin/european-engineered">European Wood </Link></li>
                            <li><Link className="text-sm md:text-lg hover:text-lime-400" to="/admin/bamboo-upload">Bamboo Flooring</Link></li>
                            <li><Link className="text-sm md:text-lg hover:text-lime-400" to="/admin/wood-accessories-upload"> Accessories</Link></li>
                            
                        </ul>
                    </div>
                <Link to='/admin/wood-edit'><button className="btn  text-sm md:text-lg ">Edit Product</button></Link>
            </div>
    <form onSubmit={wood} >
...
export default Woodproductuplode;