...
const Ducksubproduct = () => {
    const subproduct = async event => {
        ...
        fetch('https://test.zrsflooring.com/deck-sub-product',{
            method:'POST',
            headers:{
    ...
    return (
        ...
        <h3 className="text-center text-xl font-semibold text-lime-500"> Deck SubProduct</h3>
