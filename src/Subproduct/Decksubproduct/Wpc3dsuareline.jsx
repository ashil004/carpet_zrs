...
const Wpc3dsuareline = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/4pSKQhV/Wpc-3-D-Hollow-square-line-Deck-Flooring.webp)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >Wpc Hollow Square Line Deck Flooring</h1>
