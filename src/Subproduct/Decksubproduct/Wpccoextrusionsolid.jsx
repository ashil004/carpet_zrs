...
const Wpccoextrusionsolid = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/3v74QGq/banner-image-QVZHSk-Jq-SW1y-L21he-Gt-GN05q-SVcw-UT09-1.webp)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >Wpc Co-Extrusion Solid Deck Flooring</h1>
...
export default Wpccoextrusionsolid;