...
const Wpccoextrusiondecktiles = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/w4JtkSd/Wpc-Co-Extrusion-Deck-Tiles.webp)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >Wpc Co-Extrusion Deck Tiles</h1>
                ...
                <div>
                    <div className="grid xl:grid-cols-3 xl:mx-6 lg:mx-4 md:mx-2 mx-0 gap-y-4 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 mt-4">
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/XZMnq5Y/zrs-Wpc-Co-Extension-Deck-Tiles-1.webp" /></figure>
                        ...
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/xHFwbdJ/zrs-Wpc-Co-Extension-Deck-Tiles-2.webp" /></figure>
                            <div className="card-body">
                        ...
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/2NdcV79/zrs-Wpc-Co-Extension-Deck-Tiles-3.webp" /></figure>
                            <div className="card-body">
...
export default Wpccoextrusiondecktiles;