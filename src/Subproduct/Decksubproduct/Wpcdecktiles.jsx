...
const Wpcdecktiles = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/qBK6QZW/Wpc-Deck-Tiles.webp)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >Wpc Deck Tiles</h1>
                ...
                <div>
                    <div className="grid xl:grid-cols-3 xl:mx-6 lg:mx-4 md:mx-2 mx-0 gap-y-4 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 mt-4">
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/18NnNBN/zrs-acacia-deck-tiles-1.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Tiles-1</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/0FMY3Mc/zrs-acacia-deck-tiles-2.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Tiles-2</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/stY1nyc/zrs-acacia-deck-tiles-3.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Tiles-3</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/QjRgzRf/zrs-acacia-deck-tiles-4.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Tiles-4</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/JC2jQJh/zrs-acacia-deck-tiles-5.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Tiles-5</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/GdYcmJV/zrs-acacia-deck-tiles-6.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Tiles-6</h2>
