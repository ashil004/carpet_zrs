...
const Wpcsquarewood = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/9h3LSxw/Wpc-Hollow-Square-Ancient-Wood-Deck-Flooring.webp)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >Wpc Hollow Square Ancient Wood Deck Flooring</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className="m-4 ">
                <h3 className="text-3xl font-semibold ">Wpc Hollow Square Ancient Wood Deck Flooring</h3>
                <p className="text-lg mt-2" >For usage in building, WPC Hollow Square Ancient wood Deck Flooring is a material that is extremely secure and long-lasting. It consists of a mixture of thermoplastics, wood flour, and wood fiber. Additionally made from inorganic additives and plastic composites are the WPC Hollow Square Ancient wood Deck Flooring boards. Additionally, wood plastic composite is employed as a durable and upscale flooring choice. The WPC Hollow Square Ancient wood Deck Flooring is used for flooring, decking, railings, fences, landscaping, windows, doors, outdoor or indoor cladding, building door and window frames, preparing sturdy and stylish furby blending the ground Furniture, etc. WPC boards are of guaranteed quality. Stabilizing agents, modifiers, foaming agents, and other ingredients that call for precise mixing ratios are all included in these boards.
                    ...
                    <div>
                        <ul className="flex flex-wrap gap-16 pl-10 py-4">
                            ...
                            <div className="card ">
                                    <figure className="">
                                        <img
                                            src="https://i.ibb.co.com/DGSZ3yD/image-NEp-NZGMr-QXg5c-HRUc-WZj-Z08v-Mld-LZz09.png"
                                           
                                            className="" />
                                    </figure>
                                    <div className=" items-center text-center">
                                        <h2 className="text-sm ">Recyclable</h2>
                            ...
                            <li>
                                ...
                                <div className=" items-center text-center">
                                    <h2 className="text-sm">Durability</h2>
                            ...
                            <li>
                                ...
                                <figure className="">
                                    <img
                                        src="https://i.ibb.co.com/Tc0J2Wk/imaged-Hdh-QUl-TTVJx-UFh-Gdmd2-RDht-Ujdk-QT09.png"
                                       
                                        className="" />
                                </figure>
                                <div className=" items-center text-center">
                                    <h2 className="text-sm ">Low Maintenance</h2>
