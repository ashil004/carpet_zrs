...
const Wpcsolid = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/cTJMmMx/Wpc-Solid-Deck-Flooring.webp)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >Wpc Solid Deck Flooring</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className="m-4 ">
                <h3 className="text-3xl font-semibold ">Wpc Solid Deck Flooring</h3>
                <p className="text-lg mt-2" >The demand for WPC solid decking has experienced rapid expansion, and it is anticipated that this trend will continue. This is a solid alternative to conventional decking and provides a lengthy range of benefits to end users and distributors, making the investment worthwhile. The decking material WPC solid decking, often known as composite decking, is a special blend of plastic and wood. WPC, which stands for Wood Plastic Composite, is a composite comprised of additives and 45% wood fibers and 55% HDPE. WPC decking is so long-lasting that STORM offers a 10-year guarantee on our Triton WPC range against splitting, rotting, cracking, and decay. It also resists fading, staining, scratching, and mold.
