...
const Luxuria = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/0ZCBkP9/banner-imagec-Gp-IVz-Rk-N3-Q1ekxp-V2x-GUisw-TC9j-QT09-1.webp)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >Luxuria Carpet Tiles</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className="m-4 ">
                <h3 className="text-3xl font-semibold ">Luxuria Carpet Tiles</h3>
                <p className="text-lg" >The thick cut pile of Luxuria, the first Nylon 6.6 product, enhances the feel underfoot. Luxuria has a 20 year wear warranty and is moth proof, with delustered yarns to provide a matte finish that are very durable and long lasting. Available in 4 and 5 metre widths in 36 opulent colors.</p>
                <div>
                    <div className="grid xl:grid-cols-3 xl:mx-6 lg:mx-4 md:mx-2 mx-0 gap-y-4 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 mt-4">
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/PCKd36y/image-QUNXMHZw-Z2-Nkcm4ydnp5d-GNp-OFF5dz09.jpg" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Lux-102</h2>
                                

                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/njzn00w/image-Zz-JKWj-Fr-OHQy-N0dy-Vk-RIRXh-TMHh-JQT09.jpg" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Lux-103</h2>
                               

                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/1ZW8Snw/image-MVY0-MGMw-WGpr-Yn-ZINWt-CLz-Ni-VS80-Zz09.jpg" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">lux-106</h2>
                                

                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/9nyCxTT/imagebl-M0-NTYz-NHVWMz-Vw-Nlp-XOEQ1-Wm-J6-Zz09.jpg" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Lux-105</h2>
                                

                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/dgkCgKp/image-Rlgy-VGs0-Tn-Nt-Ynd-PRGVWSTlt-Rn-BYUT09.jpg" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">lux-108</h2>
                                

                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/JcGbLmP/image-Rn-BGMUR4c-GF0bn-BZNHl2a3-Zrb-Vh-BUT09.jpg" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">lux-107</h2>
                                

                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/Kq7znFY/image-Q2h-KN0p-GSz-Vu-VWlzcn-NYc-EZOSn-Q5dz09.jpg" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">lux-109</h2>
                             

                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/JnRxbW1/imagec-Epae-Dc0-K1-FZc-G9-SN3-Z1c-UVWMDAw-UT09.jpg" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">lux-110</h2>
