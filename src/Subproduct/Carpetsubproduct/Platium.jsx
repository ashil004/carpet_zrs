...
const Platium = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/s69rczH/banner-image-V2-Yv-Syt-FL0-Z1-WGJWRz-Bhaz-VYMVdu-QT09-1.webp)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >Platinum Carpet Tiles</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className="m-4 ">
                <h3 className="text-3xl font-semibold ">Platinum Carpet Tiles</h3>
                <p className="text-lg" >Ideal for all business usage, Platinum Red tufted multi-pile height cut and loop pile carpet tiles. The carpet tiles made of platinum look stunning. They are suitable for all commercial and domestic spaces, including offices, care facilities, nurseries, pubs, and other working areas. They can be installed in a variety of options, including broadloom non-directional and tessellated. 50cm by 50cm in size. These carpet tiles are made from 100% Alochrome polyamide, making them incredibly tough and long-lasting.</p>
                <div>
                    <div className="grid xl:grid-cols-3 xl:mx-6 lg:mx-4 md:mx-2 mx-0 gap-y-4 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 mt-4">
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/F34hM4q/image-Vm-Ni-Wn-Fu-Unp-JS0-FQVitx-RVZ1-S2-V5-QT09.jpg" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Pla-05</h2>
                               

                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/xG0sm4J/image-Yn-Za-MEVv-OFh-JV214-ZTBtd-Xgv-Yl-Jm-UT09.jpg" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Pla-01</h2>
                              

                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/VQrvb35/imaged-XJQTEp-QTm-J1-Un-Va-Z2-Vjb2-Vu-OHF4-UT09.jpg" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Pla-02</h2>
                               

                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/9wrZDPW/image-Nm9-Ud-Th-PZUJza-WZNTDZv-R0dj-ZXRwdz09.jpg" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Pla-03</h2>
                                

                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/YNn9gdK/imageb2-Ra-OHd-SZTZ4-ZTh2-NHp-FOWN2-L09-Idz09.jpg" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Pla-04</h2>
