...
const Epdmgymtile = () => {
    ...
    return (
        <div>
            <div>
                <div className="-mt-24">
                    <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/TR5Q6MS/EPDM-Gym-Flooring-Tiles.webp)', }}>
                        <div className="hero-overlay opacity-0"></div>
                        <div className="  text-white -mt-56 ml-12 ">
                            <h1 className="text-3xl font-bold" >EPDM Gym Flooring Tile</h1>
            ...
            <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
                ...
                <div className="m-4 ">
                    <h3 className="text-3xl font-semibold ">EPDM Gym Flooring Tile</h3>
                    <p className="text-lg" >Synthetic rubber called EPDM (ethylene propylene diene methylene) is utilized in a variety of applications, such as playground flooring and sports flooring. It is a fantastic solution for kid's playgrounds because it is secure and non-toxic. When exposed to elements like ultraviolet rays and the outdoors, EPDM flooring is made to resist the tendency to become harmed. It is excellent and suitable for outdoor applications because of its resistance to ozone, UV radiation, weathering, and many other pollutants. The primary aim of EPDM flooring is stability in both high and low temperatures, so it can be utilized in environments with temperatures ranging from -29C to 177C. With exceptionally poor electrical conductivity and withstand steam and water.
                    ...
                    <div>
                        <div className="grid xl:grid-cols-3 xl:mx-6 lg:mx-4 md:mx-2 mx-0 gap-y-4 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 mt-4">
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/1z4rXTz/EPDM-Gym-Flooring-Tile-1.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Tile-1</h2>


                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/yPSpT0M/EPDM-Gym-Flooring-Tile-2.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Tile-2</h2>


                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/PYYDPM7/EPDM-Gym-Flooring-Tile-3.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Tile-3</h2>


                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/YW7n0K9/EPDM-Gym-Flooring-Tile-4.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Tile-4</h2>


                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/Mn8swDV/EPDM-Gym-Flooring-Tile-5.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Tile-5</h2>


                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/YcpPk55/EPDM-Gym-Flooring-Tile-6.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Tile-6</h2>


                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/NLtvxX3/EPDM-Gym-Flooring-Tile-7.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Tile-7</h2>


                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/JH1bcHy/EPDM-Gym-Flooring-Tile-8.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Tile-8</h2>
