...
const Gymaccessories = () => {
    return (
        ...
        <div>
           <div className="-mt-24">
               <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/6yLGJrH/banner-image-M0hue-EZh-N3hu-Mm5zdm-Zu-SUoz-Zmow-Zz09.jpg)', }}>
                   <div className="hero-overlay opacity-0"></div>
                   <div className="  text-white -mt-56 ml-12 ">
                       <h1 className="text-3xl font-bold" >Gym & Sports Flooring Accessories</h1>
       ...
       <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
           ...
           <div className="m-4 ">
               <h3 className="text-3xl font-semibold ">Gym & Sports Flooring Accessories</h3>
               <p className="text-lg" >The optimal flooring option for your needs depends on the sport you play and the purpose of your facility. Yoga practitioners might benefit from using a foam tile, but badminton players have completely different needs. As a result, knowing what sport you will play and how you want to use the space will help you choose the ideal sports flooring. The ideal solution can then be found by navigating through items, attributes, and materials. There are a few distinct surface kinds to pick from as you begin your search for sports flooring. The ideal flooring material must meet your requirements. So that you can choose the appropriate material, it is a good idea to decide how you plan to use your facility.
