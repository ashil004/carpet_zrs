...
const Sportsgym = () => {
    ...
    return (
        <div>
            <div>
                <div className="-mt-24">
                    <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/qkshmHD/Sports-Flooring.webp)', }}>
                        <div className="hero-overlay opacity-0"></div>
                        <div className="  text-white -mt-56 ml-12 ">
                            <h1 className="text-3xl font-bold" >Sports Flooring</h1>
            ...
            <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
                ...
                <div className="m-4 ">
                    <h3 className="text-3xl font-semibold ">Sports Floorings</h3>
                    <p className="text-lg" >Size: 100cm x 100cm x 16mm black colour. These mats are suitable for use in a variety of applications including: gym flooring, exercise mat, MMA and much more! Designed and manufactured for maximum intensity, comfort, and value, these floor protectors offer a heavy-duty, rigid rubber construction that absorbs the impact of free weights, home gyms, treadmills, and nurseries. Rubber flooring ensures a natural and safe grip for excellent grip and superior impact protection. These mats will not rip, peel, stretch, crack, wrinkle or shrink even under the harshest conditions. No more floor damage, no more structural damage, and dramatically lower noise levels. Enhance any room with this shock-absorbent rubber rug. It is powerful, stable, silent and powerful. Durable enough to bounce right back every time.
                    ...
                    <div>
                        <div className="grid xl:grid-cols-3 xl:mx-6 lg:mx-4 md:mx-2 mx-0 gap-y-4 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 mt-4">
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/2Nh3PLD/Sports-Flooring-1.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Sports-1</h2>


                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/k60H2kS/Sports-Flooring-2.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Sports-2</h2>


                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/NmNxmYn/Sports-Flooring-3.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Sports-3</h2>


                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/Jv02j8P/Sports-Flooring-4.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Sports-4</h2>


                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/RCk2Lqr/Sports-Flooring-5-1.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Sports-5</h2>


                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/xGZMth4/Sports-Flooring-6-2.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Sports-6</h2>


                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/wRPLfZ0/Sports-Flooring-7.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Sports-7</h2>


                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/YtKwrTW/Sports-Flooring-8.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Sports-8</h2>


                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/LhpB5BR/Sports-Flooring-9.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Sports-9</h2>


                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/ys9Bq36/Sports-Flooring-10.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Sports-10</h2>
                    ...
                    <div>
                        <ul className="flex flex-wrap gap-16 pl-10 py-4">
                            ...
                            <li>
                                ...
                                <figure className="">
                                    <img
                                        src="https://i.ibb.co.com/CJZ7HSj/image-NHcz-Ylkx-Vkp-IV3h-NQk-ZWVk5z-WHp-GZz09.png"
                                        
                                        className="" />
                                </figure>
                                <div className=" items-center text-center">
                                    <h2 className="text-sm">Fire Prevention</h2>
                            ...
                            <li>
                                ...
                                <figure className="">
                                    <img
                                        src="https://i.ibb.co.com/dk16GYH/image-OXhk-Yzh4-T2-Nx-RGM5-U2-I0-Sl-Nlajla-QT09.webp"
                                       
                                        className="" />
                                </figure>
                                <div className=" items-center text-center">
                                    <h2 className="text-sm ">Unique Design</h2>
                            ...
                            <li>
                                <div className="card ">
                                    ...
                                    <div className=" items-center text-center">
                                        <h2 className="text-sm ">No-Slip</h2>
