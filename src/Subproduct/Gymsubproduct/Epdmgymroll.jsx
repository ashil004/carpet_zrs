...
const Epdmgymroll = () => {
    ...
    return (
        <div>
            <div>
                <div className="-mt-24">
                    <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/wztPBcJ/Epdm-Gym-Flooring-Rool.webp)', }}>
                        <div className="hero-overlay opacity-0"></div>
                        <div className="  text-white -mt-56 ml-12 ">
                            <h1 className="text-3xl font-bold" >EPDM Gym Flooring Roll</h1>
            ...
            <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
                ...
                <div className="m-4 ">
                    <h3 className="text-3xl font-semibold ">EPDM Gym Flooring Roll</h3>
                    <p className="text-lg" >EPDM ROLLS are SBR rubber rolls that have colorful EPDM flecks on them. These rolls are very flexible, which prolongs their life. Due to its abilities to absorb sound, vibration, and prevent skidding, it is appropriate for indoor spaces. These rolls can withstand fire. Rubber rolls that have been sliced into various sizes and shapes perform perfectly as sound and shock absorbers beneath treadmills and other pieces of machinery, in the workshop, or beneath wooden floors and ceramic tiles. Red, Blue, Yellow, Green, grey, white, and blended hues are the colors of EPDM specks. Rubber flooring tiles are wonderful for a wide range of uses and appropriate for practically any workout environment because they are durable, inexpensive, and simple to install.
                    ...
                    <div>
                        <div className="grid xl:grid-cols-3 xl:mx-6 lg:mx-4 md:mx-2 mx-0 gap-y-4 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 mt-4">
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/hyP832p/Epdm-Gym-Flooring-Rool-1.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title"> Rool-1</h2>


                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/80Q4dgr/Epdm-Gym-Flooring-Rool-2.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title"> Rool-2</h2>


                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/Hr6vYSB/Epdm-Gym-Flooring-Rool-3.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title"> Rool-3</h2>


                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/BwRyXc9/Epdm-Gym-Flooring-Rool-4.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title"> Rool-4</h2>


                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/y8hGKjF/Epdm-Gym-Flooring-Rool-5.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title"> Rool-5</h2>
