...
const Exhibition = () => {
    ...
    return (
        <div>
             <div>
                <div className="-mt-24">
                    <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/8jBjkmB/Exhibition-Grass.webp)', }}>
                        <div className="hero-overlay opacity-0"></div>
                        <div className="  text-white -mt-56 ml-12 ">
                            <h1 className="text-3xl font-bold" >Exhibition Grass</h1>
            ...
            <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
                ...
                <div className=" ">
                    <h3 className="text-3xl font-semibold ">Exhibition Grass</h3>
                    <p className="text-lg " >Exhibitions and showcase places are increasingly using artificial grass. Installing it is not difficult at all, and once you are done with it, you can either roll it back up for future use or throw it away. Because artificial grass is so environmentally benign, it is perfect for fairs and exhibitions. Your visitors' subliminal perceptions of color can be very powerful. The ease and speed with which artificial grass may be set up for your events and exhibits is another major advantage. The final justification for using artificial grass for your exhibition or event is its affordability. It comes in rolls of 4 and 2 meters. Because all you have to do to install it is roll the artificial grass into place, it is simple to do.</p>
                    <div>
                <div className="grid xl:grid-cols-3 xl:mx-6 lg:mx-4 md:mx-2 mx-0 gap-y-4 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 mt-4">
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56 bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/Hg8c3sp/image-Wk1-Icj-Zxe-GZne-FA5-Vys5-Mnpa-U1-ZIZz09.webp"  /></figure>
                            <div className="card-body">
                                <h2 className="card-title">FG 4077WS220-GG</h2>
                                <h2>40mm</h2>
                               
                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/CJjKvW3/image-Zm-RJTl-FCSXBs-Nk-Jta-GJn-Yksw-SVFh-Zz09.webp"  /></figure>
                            <div className="card-body">
                                <h2 className="card-title">320</h2>
                                <h2>10mm</h2>
                               
                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56 bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/qRNYGZn/image-Qzcxd-S83-Mz-Yrd-DVt-RGd-Vaj-A2-Tk12-QT09.webp"  /></figure>
                            <div className="card-body">
                                <h2 className="card-title">350</h2>
                                <h2>10mm</h2>
                               
                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/DfRtvfd/image-S3oye-GJk-Y0-VMWn-Ux-Tj-Iz-RGl0-Vl-Js-QT09.webp"  /></figure>
                            <div className="card-body">
                                <h2 className="card-title">C-117 FG</h2>
                                <h2>40mm</h2>
                               
                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/8X7Q8zM/imagea-Wo4aj-VTNHNYMU5k-RUVl-R04r-K3-Bq-UT09.webp"  /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Crown BG</h2>
                                <h2>45mm</h2>
                               
                            </div>
                        </div>
                        {/* <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/kVLWw8L/image-V3pxbk55-T09-WNm-Ns-MWJt-WXdr-K3gx-UT09.webp"  /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Crown FG</h2>
                                <h2>45mm</h2>
                               
                            </div>
                        </div> */}
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/rcRWBqG/imagec-TFTam-V2-NEEv-VDNHWDN0-Zk-NJUXROUT09.webp"  /></figure>
                            <div className="card-body">
                        ...
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56 bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/k5FLhZB/imageb0-Yya-G9-YN1-BOd1hqdj-R0a-FNicnd1-QT09.webp"  /></figure>
                            <div className="card-body">
