...
const Landscaping = () => {
    ...
    return (
        <div>
            <div>
                <div className="-mt-24">
                    <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/306c64q/green-fake-grass-is-used-carpet-walls-floors-sports-arenas-suitable-both-indoor-outdoor-use-objects.jpg)', }}>
                        <div className="hero-overlay opacity-0"></div>
                        <div className="  text-white -mt-56 ml-12 ">
                            <h1 className="text-3xl font-bold" >Landscaping Grass</h1>
            ...
            <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
                ...
                <div className=" ">
                    <h3 className="text-3xl font-semibold ">Landscaping Grass</h3>
                    <p className="text-lg" >Artificial turf from ZRS Carpets offers a long-lasting and environmentally friendly substitute that closely resembles the appearance of real grass, whether you need to cover a driveway or replace the natural grass in your courtyard. You can choose this option to avoid spending the money and time necessary to maintain your law. The main advantages of artificial grass include a year-round green appearance for your lawn, Almost no maintenance is necessary, each year, conserve hundreds of gallons of water. prevents the formation of rips and patches, removes weeds and pests without the use of harmful pesticides</p>
                    <div>
                        <div className="grid xl:grid-cols-3 xl:mx-6 lg:mx-4 md:mx-2 mx-0 gap-y-4 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 mt-4">
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/jbQgqkd/image-Y2-Jpcy9v-V3l-QNFRVYWZTMUt3a-U4z-UT09.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">3724 BG</h2>
                                    <h2>40mm</h2>

                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/C9pP2rs/image-N0-Fi-TVRwc-UJOZDJra-Thi-Qj-V2-Znhq-Zz09.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">3724 FG</h2>
                                    <h2>40mm</h2>

                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/HxKLWPp/image-VWdu-Zk1-LQkh0-TGZw-WDFa-Nnp-Ob2pl-Zz09.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Classy 4000 BG</h2>
                                    <h2>13mm</h2>

                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/D4ZcW1W/image-Zk-Nvb1-JGWl-FBa-DVOc-Uxna-E9j-VHk0-UT09.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Classy 4000 BG</h2>
                                    <h2>30mm</h2>
                            ...
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/LzVXFsC/imaged-Dli-VHgr-SUg0-Y1-NZUUNDUn-Uz-Vk14-UT09.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">L-BHY BG</h2>
                                    <h2>45mm</h2>

                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/x6YTkTc/imagee-WV5-MHZNL2-NFT1-Iw-WS9-Ccj-Y4-YU44-QT09.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">L-BHY BG</h2>
                                    <h2>40mm</h2>
                            ...
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/jbQgqkd/image-Y2-Jpcy9v-V3l-QNFRVYWZTMUt3a-U4z-UT09.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">3717 BG</h2>
                                    <h2>40mm</h2>

                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/SVQ6WCr/image-QUto-RU1-Kc-Glmb-Ghwd-Etwd3-Nn-NXp-BUT09.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">3717 FG</h2>
                                    <h2>40mm</h2>

                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/R0C3Gt7/image-Tjl1-Qit-WVExm-Z3-ROS3l5-TTNyd-Fll-QT09.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">L-BHY FG</h2>
                                    <h2>45mm</h2>

                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/1rJQzkZ/image-RTgramt5bm5aa1l-Zalp-Bb-HBUQU43-QT09.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Mattress BG</h2>
                                    <h2>48mm</h2>

                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/LRxg7Wd/image-Yk-JCWVRr-Qz-Ny-ZGdpcm5-DMj-NRYn-Z6dz09.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Mattress FG</h2>
                                    <h2>48mm</h2>
                            ...
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/LRxg7Wd/image-Yk-JCWVRr-Qz-Ny-ZGdpcm5-DMj-NRYn-Z6dz09.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Mattress plus FG</h2>
                                    <h2>50mm</h2>

                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/T8krNPZ/image-Um-FCRElr-Sj-FJOXNGVEZWc-VFx-Zkh-Fdz09.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Velvet BG</h2>
                                    <h2>50mm</h2>
                            ...
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/T8krNPZ/image-Um-FCRElr-Sj-FJOXNGVEZWc-VFx-Zkh-Fdz09.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Velvet FG</h2>
                                    <h2>50mm</h2>

                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/9g2KVqp/image-OE9n-UERwc-WN5aj-F4-Zjha-V3-ZJalk5-UT09.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Zayan BG</h2>
                                    <h2>40mm</h2>
                            ...
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/9g2KVqp/image-OE9n-UERwc-WN5aj-F4-Zjha-V3-ZJalk5-UT09.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Zayan FG</h2>
                                    <h2>40mm</h2>
