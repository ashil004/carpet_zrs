...
const Football = () => {
    ...
    return (
        <div>
            <div>
                <div className="-mt-24">
                    <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/BTzkR7x/Football-Grass.webp)', }}>
                        <div className="hero-overlay opacity-0"></div>
                        <div className="  text-white -mt-56 ml-12 ">
                            <h1 className="text-3xl font-bold" >Football Grass</h1>
            ...
            <div className="flex  mt-10  space-x-6 m-6">
                ...
                <div className="m-4 ">
                    <h3 className="text-3xl font-semibold ">Football Grass</h3>
                    <p className="text-lg" >When we are playing on the field, a pleasant setting is crucial. The largest issue is seen most clearly in the playground where we can see genuine grass. We need a solution that does not require maintenance and works well for outside play. Football artificial grass, which is now available, is created to seem like top-notch natural turf pitches. This kind of grass is created utilizing gentle, non-abrasive strands that mimic nature in appearance, texture, and functionality. Silica sand, which makes up 70% of the total weight of the infill, is environmentally benign, helps to stabilize and sustain the system. Because rounded granules resist floating or displacement in high-use areas and make up 30% of the overall infill weight, rubber granules are also advantageous for the environment, offer a softer surface, and create bounce.</p>
                    <div>
                        <div className="grid xl:grid-cols-3 xl:mx-6 lg:mx-4 md:mx-2 mx-0 gap-y-4 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 mt-4">
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/k5f20j1/image-MUMyc1-VWNW5-KQm-Rp-ZDg1-SEt-RQWp-CQT09.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Football grass FG double color</h2>
                                    <h2>50mm</h2>

                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-withe shadow-xl">
                                <figure><img src="https://i.ibb.co/x1gWB76/imageb-XJpa-EJza-Fd-Gamh3-REpza2-V4-Yjltdz09.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Football grass FG mix</h2>
                                    <h2>50mm</h2>

                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/D7WZQK1/image-OXhq-Z1-Vq-Un-Rze-C9l-UGppei81-QU1-FZz09.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Football grass FG</h2>
                                    <h2>60mm</h2>

                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/mXq7q97/image-WTh-Id3-ZKc3h-Zb-DFv-U1h1-Sn-VXY3p-Tdz09.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">white grass</h2>
                                    <h2>50mm</h2>
