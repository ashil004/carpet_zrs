...
const Playground = () => {
    ...
    return (
        <div>
            <div>
                <div className="-mt-24">
                    <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/fXP6yCw/Playground-Grass.webp)', }}>
                        <div className="hero-overlay opacity-0"></div>
                        <div className="  text-white -mt-56 ml-12 ">
                            <h1 className="text-3xl font-bold" >Playground Grass</h1>
            ...
            <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
                ...
                <div className="m-4 ">
                    <h3 className="text-3xl font-semibold ">Playground Grass</h3>
                    <p className="text-lg" >Products made of synthetic playground turf offer a consistently safe surface that can shield users from harm and bacteria without cutting into their valuable playtime. You can count on ZRS Carpets to provide you with the same high-quality goods that have helped us establish ourselves as a leader in numerous industries, whether you need to surface a business or domestic play area. We take satisfaction in the numerous advantages that both commercial and residential customers receive from our goods, such as the hypoallergenic play surface. Protects against bugs, limits exposure to harmful chemicals required to maintain natural grass, and is cushioned to soften impacts</p>
                    <div>
                        <div className="grid xl:grid-cols-3 xl:mx-6 lg:mx-4 md:mx-2 mx-0 gap-y-4 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 mt-4">
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                ...
                                <div className="card-body">
                                    <h2 className="card-title">DM BG</h2>
                                    <h2>50mm</h2>
                            ...
                            {/* <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                ...
                                <div className="card-body">
                                    <h2 className="card-title">DM FG</h2>
                                    <h2>50mm</h2>
                            ...
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                ...
                                <div className="card-body">
                                    <h2 className="card-title">GLP R65 BG</h2>
                                    <h2>40mm</h2>
                            ...
                            {/* <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                ...
                                <div className="card-body">
                                    <h2 className="card-title">GLP R65 FG</h2>
                                    <h2>40mm</h2>

                                </div>
                            </div> */}
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/dQm6WZM/image-Kz-Bzb-Elpdjda-RTl-SNUQw-R1-Yr-V2l-Jdz09.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">LV BG</h2>
                                    <h2>36mm</h2>

                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/qdt8ppB/imagebn-VQNl-RDd-Hcv-Rkswa-FNJVVUrd-Ct-XQT09.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">MF FG</h2>
                                    <h2>22mm</h2>
                            ...
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                ...
                                <div className="card-body">
                                    <h2 className="card-title">N01 BG</h2>
                                    <h2>22mm</h2>
                            ...
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                ...
                                <div className="card-body">
                                    <h2 className="card-title">Natural FG</h2>
                                    <h2>40mm</h2>
                            ...
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                ...
                                <div className="card-body">
                                    <h2 className="card-title">CrownBG</h2>
                                    <h2>45mm</h2>
                            ...
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/T8krNPZ/image-Um-FCRElr-Sj-FJOXNGVEZWc-VFx-Zkh-Fdz09.webp" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">CrownFG</h2>
                                    <h2>45mm</h2>
