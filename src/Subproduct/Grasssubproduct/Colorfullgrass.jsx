...
const Colorfullgrass = () => {
    ...
    return (
        <div>
            <div>
                <div className="-mt-24">
                    <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/gWDRs8b/banner-image-RDBUbl-E1-ZUl-MRWl-CUk-Vz-RVp1-T0-F5-QT09.jpg)', }}>
                        <div className="hero-overlay opacity-0"></div>
                        <div className="  text-white -mt-56 ml-12 ">
                            <h1 className="text-3xl font-bold" >Colorful Grass</h1>
            ...
            <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
                ...
                <div className="">
                    <h3 className="text-3xl font-semibold ">Colorful Grass</h3>
                    <p className="text-lg " >Colorful artificial grass is a great way to add a pop of color to your garden or landscape. It is available in vibrant shades and is perfect for low-traffic areas both indoors and outdoors. It is eco-friendly, lead-free, and easy to install. You can choose any type of grass that will be perfect for playing, gardening, relaxing, and pet activities. So, if you’re looking for a way to add some color to your outdoor space, colorful artificial grass might be just what you need! </p>
                    <div>
                        <div className="grid xl:grid-cols-3 xl:mx-6 lg:mx-4 md:mx-2 mx-0 gap-y-4 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 mt-4">
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/6W5VcN1/Yellow.png" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Colorful 26C140 Yellow Grass</h2>
                                    <h2>26mm</h2>

                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56 bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/hfsQH6t/Red.png" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Colorful 26C140 Red Grass</h2>
                                    <h2>26mm</h2>

                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/6W1KvFg/Purple.png" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Colorful 26C140 Purple Grass</h2>
                                    <h2>26mm</h2>

                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/dJnqdSV/Blue.png" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Colorful 26C140 Blue Grass</h2>
                                    <h2>26mm</h2>

                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/VVkqcnD/Black.png" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Colorful 26C140 Black Grass</h2>
                                    <h2>26mm</h2>

                                </div>
                            </div>
                            <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                                <figure><img src="https://i.ibb.co/crkCNBB/GREEN-Main.png" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Colorful 26C140 Green Grass</h2>
                                    <h2>26mm</h2>
