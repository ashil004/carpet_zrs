...
const Lvtaccessories = () => {
    ...
    return (
        <div>
             <div>
                <div className="-mt-24">
                    <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/jyTMLWC/banner-imaged-Xh0-Uz-Ztc-GZYej-Z4-Nk-NLV2d-DYkx-TUT09-1.jpg)', }}>
                        <div className="hero-overlay opacity-0"></div>
                        <div className="  text-white -mt-56 ml-12 ">
                            <h1 className="text-3xl font-bold" >Lvt Flooring Accessories</h1>
