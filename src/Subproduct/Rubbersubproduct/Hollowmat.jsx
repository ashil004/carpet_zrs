...
const Hollowmat = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/FYSvw9M/banner-image-NVZ2-Nm-JCNHU0cn-BBL2k3a1-FGM3-U2-UT09-1.jpg)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >Hollow Mat</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className="m-4 ">
                <h3 className="text-3xl font-semibold ">Hollow Mat</h3>
                <p className="text-lg mt-2" >There are numerous reasons why our hollow mats are becoming more and more popular in both business and domestic settings. These mats provide unparalleled convenience and safety on the market. Commercial settings experience high foot traffic, making the toughness of these mats ideal for those locations. To meet consumer needs, they come in a variety of sizes and designs. These are frequently utilized in homes, kitchens, water surface areas, etc.
