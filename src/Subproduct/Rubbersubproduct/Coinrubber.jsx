...
const Coinrubber = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/Qp3WdrK/banner-image-Z3-FPNDl-OWTM1cj-Q0-Z3-Aya-GFn-NHM0-QT09.webp)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >Coin Rubber Flooring</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className="m-4 ">
                <h3 className="text-3xl font-semibold ">Coin Rubber Flooring</h3>
                <p className="text-lg mt-2" >ZRS Carpets has a wide selection of Coin Rubber Mat Rolls available. Due to its extensive use, the Coin Rubber Mat Rolls that we provide are highly sought after by clients. These goods are renowned for their exact use and are appropriate for many applications. Coin Rubber is Long-Lasting, Flexible in Design, and Durable.
