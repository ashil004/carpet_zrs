...
const Horsemat = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/fMNtmWH/banner-imagec1d-PK25-TWUVGekp3-Sit-YRk50-Tnlq-QT09-1.jpg)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >Horse mat</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className="m-4 ">
                <h3 className="text-3xl font-semibold ">Horse mat</h3>
                <p className="text-lg mt-2" >Recycled crumb rubber of the highest quality is used to make horse stall mats. Although it may seem like the ideal requirement for gym flooring, keep in mind that these mats are made for horses. The main objective of the product is to give thoroughbreds and other large animals a comfortable floor. Horse stall mats for use in gyms are normally 4' by 6' mats with a thickness of either 12" or 3". They are a well-liked option for home gym mats due to their low cost and accessibility. These mats are a cheap way to get your feet wet if you want to test the waters before committing to your home gym.
