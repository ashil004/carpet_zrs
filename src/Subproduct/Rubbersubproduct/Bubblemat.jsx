...
const Bubblemat = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/Z25DbV2/banner-image-TCt-Xe-Gh-RMHl-LYk-JJOVRIMll-LZWd-OQT09-1.jpg)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >Bubble Mat</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className="m-4 ">
                <h3 className="text-3xl font-semibold ">Bubble Mat</h3>
                <p className="text-lg mt-2" >Raised bubble surface built to be safe and comfortable while keeping fatigue in mind. Beveled edges are built into the bubble mat for safety and handcart access. Bubble mat adds comfort and allows air to move underneath shoes. It is perfect for industrial applications, assembly lines, food processing, safety walkways, and workstations. Raised bubble surface built to be safe and comfortable while keeping fatigue in mind. Beveled edges are built into the bubble mat for safety and handcart access. Also adds comfort and allows air to move underneath shoes. It is perfect for industrial applications, assembly lines, food processing, safety walkways, and workstations.
