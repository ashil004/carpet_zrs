...
const Linerubber = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/BrTS3tY/banner-image-ZWI2-Z1l-VYzh5-Sl-Ja-Ryt-GWFNi-Y1p5-QT09.webp)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >Line Rubber Flooring</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className="m-4 ">
                <h3 className="text-3xl font-semibold ">Line Rubber Flooring</h3>
                <p className="text-lg mt-2" >Despite line rubber flooring's apparent toughness, these surfaces can be very prone to deterioration. Repairing materials like wood and tile can be very expensive. The flooring may need to be completely redone in several situations. A broken floor can present a safety risk in addition to being unsightly visually. When it comes to safeguarding your current surfaces, lined rubber floors—whether they be installed as rubberized floor tiles or rolled rubber mats—are the ideal choice. Rubber is perfect for applications involving flooring because of its physical durability. While natural rubber flooring is certainly a solid choice, it is especially true if the rubber floors are constructed of recycled rubber.
