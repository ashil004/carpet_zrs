...
const Soundproft = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/b76NYLt/banner-imageb0-Rh-MGsre-Wd-Rek9-We-XRmd-G5-Ld-Xdr-UT09.jpg)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >Sound Proof Mat</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className="m-4 ">
                <h3 className="text-3xl font-semibold ">Sound Proof Mat</h3>
                <p className="text-lg mt-2" >Floor mats that are soundproof reduce or absorb noise. Typically, a noise reduction mat inserts a soft layer between the structure of the building and the source of the noise, reducing transmission. Soundproof floor mats are more effective against impact noises than airborne noises due to placement and composition. Let us briefly go over the differences to see why this is the case. There are several reasons why you might want to make your floor quieter, including loud footfall or creaking floors. Soundproof floor mats are one of the simplest and most affordable solutions I have come across. They are customizable to your demands and spare you from having to perform significant DIY.
