...
const Cointiles = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/Pj6bqyL/banner-image-Zkxqcl-E3-Kz-Y5-UDZy-MTM5-Qk-FJWUd-NQT09.jpg)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >Coin Tile Flooring</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className="m-4 ">
                <h3 className="text-3xl font-semibold ">Coin Tile Flooring</h3>
                <p className="text-lg mt-2" >'ZRS Carpets' Coin Tile was created for use in residential garages and is strong enough to support big loads like rolling lifts, hefty tool chests, and SUVs. In addition to our textured surface, the Coin Top surface pattern is intended to give an extra layer of protection when walking on them. The high-impact polymer material used to make the tiles is lightweight and robust enough to handle large rollover loads. High-impact polymers are also incredibly stain resistant. Because materials do not adhere to them well, the tiles are quite stain-resistant.
