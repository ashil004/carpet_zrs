...
const Evamat = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/pQn0jZC/banner-image-Mld-JVkx-LMHh-MNVJFUWd-LYzl0-YWZGZz09.webp)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >EVA Mat</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className="m-4 ">
                <h3 className="text-3xl font-semibold ">EVA Mat</h3>
                <p className="text-lg mt-2" >Eva mat is utilized for a variety of flooring materials, as well as Cosplay outfits, sporting goods, crafts, and set design. It is an ethylene and vinyl acetate polymer, which is soft but strong. EVA mat is simple to work with and is available in a range of hues and densities. EVA mat flooring is ideal for fitness rooms, gyms, weight rooms, trade exhibitions, martial arts studios, and more because to its versatility. The EVA mat's many advantages include noise absorption, which is a bonus for a gym or office space. Additionally, it is anti-fatigue; the softness of the cloth reduces weariness from prolonged standing. They are No-Slip mats, and because of their exceptional grip, they will not slide on slippery floors.
