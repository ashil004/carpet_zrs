...
const Rubberaccessries = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/QK1LD4Q/banner-imaged-Hdh-QUl-TTVJx-UFh-Gdmd2-RDht-Ujdk-QT09-1.jpg)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >Rubber Flooring Accessories</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className="m-4 ">
                <h3 className="text-3xl font-semibold ">Rubber Flooring Accessories</h3>
                <p className="text-lg mt-2" >Customers can choose whether they want tile or sheet, and they can customize their stair tread, wall base, transitions, and landing tiles. It is possible to synchronize a huge variety of colors and formats. When switching from one type of flooring to another or from one area to another, these are helpful. A room can be cohesively put together by facilitating all the design alternatives. The horizontal section at the top of each step is known as the tread. Good stair treads provide grip to reduce the risk of slips and falls. Base trim and wall base are related terms. It fills in any openings between the floor and the wall and offers a wall-protecting edge that is simple to clean.
...
export default Rubberaccessries;