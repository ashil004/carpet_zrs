...
const Rubbertile = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/3v5BxQf/banner-image-R1h-BYTJQL1c3-Zz-Y3emxu-V2pv-Mkxw-QT09.webp)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >Rubber Tile Flooring</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className="m-4 ">
                <h3 className="text-3xl font-semibold ">Rubber Tile Flooring</h3>
                <p className="text-lg mt-2" >Rubber flooring tiles are wonderful for a wide range of uses and appropriate for practically any workout environment because they are durable, inexpensive, and simple to install. They fit any space and are very simple to assemble by clicking in like puzzle pieces. They can also be added at any time. It guarantees stability, offers a good grip, withstands heavy loads and high impact activity, feels soft and comfortable underfoot, and provides excellent cushioning and shock absorption. Rubber is also very strong and resilient. Rubber floor tiles are available in a wide range of textures and colors, allowing you to select the ideal tones and shades to complement your interior design, add some flair to the room with unique colors and patterns, or keep it straightforward with solid
