...
const Linoleumvinyl = () => {
    ...
    return (
        ...
        <div>
           <div className="-mt-24">
               <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/0nb0VKt/banner-image-Mlh-YOVdm-Ul-NVREd1-Sll0b-Uh-PNzd-PZz09-1.webp)', }}>
                   <div className="hero-overlay opacity-0"></div>
                   <div className="  text-white -mt-56 ml-12 ">
                       <h1 className="text-3xl font-bold" >Linoleum Vinyl Flooring</h1>
       ...
       <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
           ...
           <div className="m-4 ">
               <h3 className="text-3xl font-semibold ">Linoleum Vinyl Flooring</h3>
               <p className="text-lg" >Linoleum is a composite flooring made of organic ingredients including cork dust, wood flour, linseed oil that has been hardened, pine rosin, and other things. It peaked in popularity in the early 1900s and was a popular choice for flooring in homes up until the 1940s. Linoleum floors come in a range of designs. This has fewer variables than vinyl flooring but is good for making huge patterns or blocks of solid color. Linoleum flooring, invented by Frederick Walton in the 1850s, is manufactured from organic materials like linseed oil, pine rosin, and cork dust and has a burlap or canvas backing.</p>
               <div>
           <div className="grid xl:grid-cols-3 xl:mx-6 lg:mx-4 md:mx-2 mx-0 gap-y-4 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 mt-4">
                   <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                       <figure><img src="https://i.ibb.co/ZLm7q60/image-UGZ5-Yk-FNRll-Yd0p-NMn-Rsc-Eoy-TUNXUT09.webp"  /></figure>
                       <div className="card-body">
                           <h2 className="card-title">551221</h2>
                           
                          
                       </div>
                   </div>
                   <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                       <figure><img src="https://i.ibb.co/Hr36Pr0/image-RXc3-YUJJUWFBNXF3-V1-NOK0src-Wludz09-1.webp"  /></figure>
                       <div className="card-body">
                           <h2 className="card-title">551223</h2>
                          
                          
                       </div>
                   </div>
                   <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                       <figure><img src="https://i.ibb.co/ZRQHrpq/image-ZVd-LUUl5-Njh-DWk-FQNz-Fw-Vjg1clp-IZz09.webp"  /></figure>
                       <div className="card-body">
                           <h2 className="card-title">556211</h2>
                          
                          
                       </div>
                   </div>
                   <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                       <figure><img src="https://i.ibb.co/LPGm8qZ/imageb-GI4clh-Uc-XN1-SDUya-EJt-OFVm-Qjk2-UT09-1.webp"  /></figure>
                       <div className="card-body">
                           <h2 className="card-title">556701</h2>
                   ...
                   <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                       <figure><img src="https://i.ibb.co/8K1YYdj/image-Rmp4-UXZ5-Z2-VQV3l-Ge-Uhi-S2-Npb1-V3-QT09-1.webp"  /></figure>
                       <div className="card-body">
                           <h2 className="card-title">556213</h2>
                          
                          
                       </div>
                   </div>
                   <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                       <figure><img src="https://i.ibb.co/RhkBmXw/imagebj-B4-UWVy-Tl-JPNFMw-Tj-ZHM0-FRd-W83-Zz09-1.jpg"  /></figure>
                       <div className="card-body">
                   ...
                   <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                       <figure><img src="https://i.ibb.co/SPD63cv/image-ZUxk-R0-Voa-U94bn-U3-Qm9-ZOUdt-VS9i-UT09.jpg"  /></figure>
                       <div className="card-body">
                           <h2 className="card-title">Blue</h2>
