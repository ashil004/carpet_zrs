...
const Homogeneous = () => {
    ...
    return (
        <div>
             <div>
                <div className="-mt-24">
                    <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: '   url(https://i.ibb.co/bRr7jLG/banner-image-RHor-SGt6-Zndp-Wmtu-TVh-MSkt4-N2-RFUT09.jpg)', }}>
                        <div className="hero-overlay opacity-0"></div>
                        <div className="  text-white -mt-56 ml-12 ">
                            <h1 className="text-3xl font-bold" >Homogeneous Medical Vinyl Flooring</h1>
            ...
            <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
                ...
                <div className="m-4 ">
                    <h3 className="text-3xl font-semibold ">Homogeneous Medical Vinyl Flooring</h3>
                    <p className="text-lg" >A single layer of homogeneous vinyl provides vibrancy and depth of color. It is a fantastic flooring option for locations with high usage because it is highly resilient and stain resistant. Because of their dependability, ease of upkeep, and versatility, vinyl floors are particularly well-liked. A single layer of homogeneous vinyl provides vibrancy and depth of color. It is a fantastic flooring option for locations with high usage because it is highly resilient and stain resistant.</p>
                    <div>
                <div className="grid xl:grid-cols-3 xl:mx-6 lg:mx-4 md:mx-2 mx-0 gap-y-4 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 mt-4">
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/kBmdXC3/imaged-G9-Uby9-VU1-U1-RTNBWDg0-L3h4-OUVIdz09.webp"  /></figure>
                            <div className="card-body">
                                <h2 className="card-title">3001 - lT Grey</h2>
                                
                               
                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/5ndPyWg/imagedk-Z3-Mm-RVb-WVFa-FRWUE9-MWGZTSEsw-UT09.webp"  /></figure>
                            <div className="card-body">
                                <h2 className="card-title">D3007 - Dark Beige</h2>
                        ...
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/kBmdXC3/imaged-G9-Uby9-VU1-U1-RTNBWDg0-L3h4-OUVIdz09.webp"  /></figure>
                            <div className="card-body">
                                <h2 className="card-title">3031 - Beige</h2>
                        ...
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/jyw29Jz/image-S21p-N2-FSNz-BTVzl2-Uzlva2-Rv-Zld-PQT09.webp"  /></figure>
                            <div className="card-body">
                                <h2 className="card-title">3022 - Dark Blue</h2>
                               
                               
                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/vZ2wW7x/image-ZUFGNz-NYN1-RIZm-Rlbz-VCWm-JLYWEv-QT09.webp"  /></figure>
                            <div className="card-body">
                                <h2 className="card-title">3027 - Blue</h2>
