...
const Cresto = () => {
    ...
    return (
        ...
        <div>
           <div className="-mt-24">
               <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/3YJLP0h/banner-image-ZUww-ZXN2-Q1-R3d-FVBbjgw-Yys3a-Vc0-Zz09-1.webp)', }}>
                   <div className="hero-overlay opacity-0"></div>
                   <div className="  text-white -mt-56 ml-12 ">
                       <h1 className="text-3xl font-bold" >Cresto Vinyl Flooring</h1>
       ...
       <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
           ...
           <div className="">
               <h3 className="text-3xl font-semibold ">Cresto Vinyl Flooring</h3>
               <p className="text-lg  " >Vinyl flooring is a type of resilient flooring made from synthetic materials, primarily polyvinyl chloride (PVC). It is a popular and versatile flooring option used in both residential and commercial spaces.</p>
               <div>
