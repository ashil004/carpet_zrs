...
const Heterogeneous = () => {
    ...
    return (
        <div>
             <div>
                <div className="-mt-24">
                    <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/yswXgvT/banner-imagedmp-VRFB1-T3h3-M1-Ar-Tz-Qwc-DZu-Tz-Nv-Zz09.jpg)', }}>
                        <div className="hero-overlay opacity-0"></div>
                        <div className="  text-white -mt-56 ml-12 ">
                            <h1 className="text-3xl font-bold" >Heterogeneous Vinyl Flooring</h1>
            ...
            <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
                ...
                <div className="m-4 ">
                    <h3 className="text-3xl font-semibold ">Heterogeneous Vinyl Flooring</h3>
                    <p className="text-lg" >Heterogeneous Vinyl Flooring is a kind of vinyl floor that is made using a unique procedure and contains five distinct layers from top to bottom. The wear layer of heterogeneous vinyl flooring is primarily responsible for its wear resistance. The thickness of the wear layer determines the wear rate of multi-layer flooring. Check out the available options and choose the best-suited one for your space.</p>
                    <div>
                <div className="grid xl:grid-cols-3 xl:mx-6 lg:mx-4 md:mx-2 mx-0 gap-y-4 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 mt-4">
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/c2sjVrD/imaged2-Ny-Tj-Y5b-E9-Ldj-Zn-Ml-Fj-RUl-VUl-J6-QT09.jpg"  /></figure>
                            <div className="card-body">
                                <h2 className="card-title">TRENDO PTD-182053</h2>
                                
                               
                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/Jm1P4br/image-TWs4dm5sa-FZi-NERpd-EZJZDhsb-FVsdz09.jpg"  /></figure>
                            <div className="card-body">
                                <h2 className="card-title">TRENDO PTD-182060</h2>
                               
                               
                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/xzDvN4g/image-NSt-Kd-Eple-Wprc-XJudn-Bl-N1p-OTE5-MQT09.jpg"  /></figure>
                            <div className="card-body">
                                <h2 className="card-title">TRENDO PTD-182070</h2>
                               
                               
                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/kBYD1Dd/image-SHBJe-Hgx-Rndib-VJQakgv-VU1ncm-V3-Zz09-1.jpg"  /></figure>
                            <div className="card-body">
                                <h2 className="card-title">TRENDO PTD-182076</h2>
