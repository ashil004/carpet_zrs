...
const Sigmamedical = () => {
    ...
    return (
        ...
        <div>
           <div className="-mt-24">
               <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/kDKGG2t/banner-image-Rmwz-M0-VZTVd-QYVRRMWNh-VHRq-VXJHdz09-2.webp)', }}>
                   <div className="hero-overlay opacity-0"></div>
                   <div className="  text-white -mt-56 ml-12 ">
                       <h1 className="text-3xl font-bold" >Sigma Medical Vinyl Flooring</h1>
       ...
       <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
           ...
           <div className="m-4 ">
               <h3 className="text-3xl font-semibold ">Lvt Flooring Accessories</h3>
               <p className="text-lg" >A cutting-edge vinyl flooring design is LVT, or Luxuria Vinyl Tile. It is becoming a more widely used and cost-effective substitute. Transitional furniture and complementary vinyl tile accessories are examples of small things that make a huge difference. With Z&S Carpets' finishing touches, you may create a polished appearance. To bridge the space between two floors of the same height, accessories like T-Moldings are employed. The space between floors with different heights is filled with surface reducers. Stair noses are used to complete a step's end.</p>
               <div>
           <div className="grid xl:grid-cols-3 xl:mx-6 lg:mx-4 md:mx-2 mx-0 gap-y-4 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 mt-4">
                   <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                       <figure><img src="https://i.ibb.co/f87PP5g/image-Tm-VFc-XU1-VVRa-Sl-Ny-T2-Rp-VU55-OXM3dz09.webp"  /></figure>
                       <div className="card-body">
                           <h2 className="card-title">Mint Green</h2>
                           
                          
                       </div>
                   </div>
                   <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                       <figure><img src="https://i.ibb.co/fqmXwXx/image-ZWY2-SEpaa-Gh5-Q2sz-NUhr-WXB3a0-Nudz09.webp"  /></figure>
                       <div className="card-body">
                           <h2 className="card-title">Ruby Blue</h2>
                          
                          
                       </div>
                   </div>
                   <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                       <figure><img src="https://i.ibb.co/P5LBn9h/image-S3dl-UHJhd1-F0-YU1-YZ2x5-U1-Fxc-Ux-CQT09.webp"  /></figure>
                       <div className="card-body">
                           <h2 className="card-title">Y80140 - Smoke Grey</h2>
                   ...
                   <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                       <figure><img src="https://i.ibb.co/4YN4CcZ/imaged-Tc4b0-Q3az-Zm-ZCtr-OUZ6el-Jubm-ZWZz09.webp"  /></figure>
                       <div className="card-body">
                           <h2 className="card-title">Y81001 - Steel Grey</h2>
                          
                          
                       </div>
                   </div>
                   <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                       <figure><img src="https://i.ibb.co/3yDFVBK/imagea-TRRe-ERRR25v-Z3p-SVDFYSEJs-MEx-GUT09.webp"  /></figure>
                       <div className="card-body">
                           <h2 className="card-title">Y81004 - Muddy Beige</h2>
                          
                          
                       </div>
                   </div>
                   <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                       <figure><img src="https://i.ibb.co/2dWsWvs/image-V2-J5d-VA1-U3-ZHRHZk-Tmxx-YW5-MNHh-DZz09.webp"  /></figure>
                       <div className="card-body">
                           <h2 className="card-title">Y81036 - Aqua Blue</h2>
