...
const Granitevinyl = () => {
    ...
    return (
        ...
        <div>
           <div className="-mt-24">
               <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/6b7c8Mg/banner-image-SGRq-UDdm-VTZi-MU42-Vmx-IQ1-B4-Wno3-Zz09-2.webp)', }}>
                   <div className="hero-overlay opacity-0"></div>
                   <div className="  text-white -mt-56 ml-12 ">
                       <h1 className="text-3xl font-bold" >Granite Vinyl</h1>
       ...
       <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
           ...
           <div className="m-4 ">
               <h3 className="text-3xl font-semibold ">Granite Vinyl</h3>
               <p className="text-lg" >Granite Vinyl is a 1.5mm thick, waterproof, oil-proof, and resistant vinyl product. The material is 12" × 12", improved to 1.5 mm in thickness, and significantly more robust and resilient for areas with high activity. The cost-effective alternative to actual ceramic tiles is this vinyl stick-down imitation tile. Old, unsightly floors can be quickly and temporarily fixed in the kitchen, bathroom, bedroom, dining room, living room, laundry room, basement, garage, office, RV, or any other home or business improvement project. The self-adhesive yellow marble granite floor tiles are incredibly simple to install—just stick and peel. They can be easily cut with a utility knife, and their strong adhesion allows you to lift them up for adjustments without risking damage to the target surface.</p>
               <div>
           <div className="grid xl:grid-cols-3 xl:mx-6 lg:mx-4 md:mx-2 mx-0 gap-y-4 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 mt-4">
                   <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                       <figure><img src="https://i.ibb.co/BsSCKnn/image-Nn-B2-VHJs-YUd3-M3-Nt-MGh-Kd-GIx-Tzdz-UT09.webp"  /></figure>
                       <div className="card-body">
                           <h2 className="card-title">206-GAMA</h2>
                           
                          
                       </div>
                   </div>
                   <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                       <figure><img src="https://i.ibb.co/4pmxL9w/image-SWFxd-Gt-Id-GFLVis0-Um00-Q3-ZKY2-VCdz09.webp"  /></figure>
                       <div className="card-body">
                           <h2 className="card-title">227-15</h2>
                          
                          
                       </div>
                   </div>
                   <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                       <figure><img src="https://i.ibb.co/z62HtJX/imaged0-F0-Rkp-BUG5-MUU16-WW9-PNXhycl-NHdz09.webp"  /></figure>
                       <div className="card-body">
                           <h2 className="card-title">217102</h2>
                          
                          
                       </div>
                   </div>
                   <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                       <figure><img src="https://i.ibb.co/XLq5P0N/imagec-Gc1-VUEz-Z2hhe-XY1-Qnhx-N1-R0-MTQwdz09.webp"  /></figure>
                       <div className="card-body">
                           <h2 className="card-title">551020</h2>
                          
                          
                       </div>
                   </div>
                   <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                       <figure><img src="https://i.ibb.co/TKx8ygB/image-Nml-La2xkel-U1-Y2-Jh-L21-Lc-G9j-MVl-Odz09.webp"  /></figure>
                       <div className="card-body">
                           <h2 className="card-title">552701</h2>
                          
                          
                       </div>
                   </div>
                   <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                       <figure><img src="https://i.ibb.co/M7TgrVB/imageb-GV5blp1-ZFl-PSGlh-TTBJSGRpe-Ups-QT09.webp"  /></figure>
                       <div className="card-body">
