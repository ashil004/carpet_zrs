...
const Vinylaccessories = () => {
    return (
        <div>
             <div>
                <div className="-mt-24">
                    <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/Vx3CFSc/banner-image-ZSt-LRl-Jm-U2-Js-ZXlvel-NJN3-Ni-L2c1dz09.jpg)', }}>
                        <div className="hero-overlay opacity-0"></div>
                        <div className="  text-white -mt-56 ml-12 ">
                            <h1 className="text-3xl font-bold" >Vinyl Flooring Accessories</h1>
            ...
            <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
                ...
                <div className="m-4 ">
                    <h3 className="text-3xl font-semibold ">Vinyl Flooring Accessories</h3>
                    <p className="text-lg" >Excellent option for installing vinyl plank flooring. You will require a few add-ons to help you complete your tasks if you want to make your project a success. The purpose of vinyl flooring accessories is to provide a uniform finish for your floor project, fill the space between the wall and the floor, bridge gaps at room entrances, and produce a stable layer for your floor installation. Stair nosing is not necessary because stair treads are utilized to completely cover each stair's top layer. To complete the end of a step, stair noses are employed. End caps are used to close any gaps between the floor and sliding doors, rugs, or hearths.
...
export default Vinylaccessories;