...
const Coinvinyl = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/NSmP7HL/banner-image-RXVl-VUNDNXJKRUx-XZ2h-OOHp-Hd0x-UZz09-1.jpg)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >Coin Vinyl Flooring</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className="m-4 ">
                <h3 className="text-3xl font-semibold ">Coin Vinyl Flooring</h3>
                <p className="text-lg " >Utilize vinyl with a coin pattern to design a fantastic garage. These rolls, which come in a huge selection of colors, are created from extremely resilient Utilize vinyl with a coin pattern to design a fantastic garage. These rolls, which come in a broad range of colors, are composed of extremely durable vinyl and are intended to add flair and value to your garage. They are ideal for do-it-yourself installations. Start enjoying your brand-new garage flooring by rolling out your Nitro Roll. Your flooring will be the center of attention whether you are parking your car or watching the game with pals. It is intended to enhance the look and value of your garage.</p>
                <div>
                    <div className="grid xl:grid-cols-3 xl:mx-6 lg:mx-4 md:mx-2 mx-0 gap-y-4 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 mt-4">
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/YdmrLYB/image-N2-RWb-TJsa-WZKNVh-QSU16-RG83-RGVJUT09.webp" /></figure>
                        ...
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/1vT3xtS/image-Sld-CZz-VLMHpa-N0-Uwd-Uox-OGc4-NFJZZz09.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Grey</h2>
                                <h2>2mm</h2>
                        ...
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/WHBFrPx/imageb-U5x-Yk-JXZWRz-ZHAv-Vj-Jlbz-VVd-Wpodz09.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Dark Grey</h2>
                                <h2>1.5mm</h2>
                        ...
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/5KjhK9N/image-Ulk2-NEdp-Sit-NUHNFZzh3-UXBJNm1-Qdz09.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Lite Grey</h2>
                                <h2>1.5mm</h2>
