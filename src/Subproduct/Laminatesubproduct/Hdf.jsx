...
const Hdf = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/5x4TwMf/banner-image-Yn-Za-MEVv-OFh-JV214-ZTBtd-Xgv-Yl-Jm-UT09-1.webp)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >HDF (High Density Fiberboard Flooring)</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className="m-4 ">
                <h3 className="text-3xl font-semibold ">HDF (High Density Fiberboard Flooring)</h3>
                <p className="text-lg" >High-density fiberboard (HDF), sometimes referred to as hardboard, is a reasonably affordable composite wood building material. It is an engineered, composite wood board, and it may substitute wood in various interior design elements like molding, flooring, and cabinets. The best way to explain what a high-density fiberboard actually is is to describe how it is made, basically, fine wooden fibers are combined with a resin and then exposed to great pressure. A composite wood substance with a high density is produced when this compression and heat are combined.
