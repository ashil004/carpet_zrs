...
const Laminateacessries = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/qnfPVpn/banner-image-Y3h0empn-Uy9i-K3-NFKz-BNZTR0aldzdz09.webp)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >Laminate Flooring Accessories</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className="m-4 ">
                <h3 className="text-3xl font-semibold ">Laminate Flooring Accessories</h3>
                <p className="text-lg" >Due to its opulent, alluring, and chic look, real wood flooring has long been a favorite in both residential and business settings. Together, the warm textures, vibrant colors, and robust durability form a powerful and long-lasting basis for each room. A few accessories are necessary for proper wood floor installation in order to guarantee a flawless surface and longevity. Like veneered skirting, which is used to fill the gaps between flooring and walls to stop dirt and dust from gathering under the floor. It has a significant impact on wall scratch protection as well. One of the most important wood flooring accents, beadings help to close the space between the floor and the wall to keep the latter looking tidy and neat.
...
export default Laminateacessries;