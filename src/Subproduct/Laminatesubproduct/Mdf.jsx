...
const Mdf = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/dJr678V/banner-imaged-XJQTEp-QTm-J1-Un-Va-Z2-Vjb2-Vu-OHF4-UT09-2.webp)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >MDF (Medium Density Fiberboard Flooring)</h1>
        ...
        <div className="bg-base-200 h-56 pt-20">
