...
const Higherspc = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/Xb92q7d/banner-image-Zz-JKWj-Fr-OHQy-N0dy-Vk-RIRXh-TMHh-JQT09.webp)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >Higher Spc Flooring</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className="m-4 ">
                <h3 className="text-3xl font-semibold ">Higher Spc Flooring</h3>
                <p className="text-lg mt-2" >Higher spc flooring is also used in the home, SPC vinyl flooring is one of the best options for areas with a lot of foot traffic, such as hotels or workplaces. This name, which is an abbreviation for Solid Polymer Composite, alludes to the material's stiff composition, which is more so than that of conventional vinyl due to the core's construction of stabilizers and limestone. The "next generation" of vinyl flooring is SPC. They are also 100% water resistant, making them much more versatile and appropriate for all types of spaces, including wet rooms in the home like bathrooms and kitchens, in contrast to wood and laminate flooring. Vinyl floors are made of many layers, with a high-density wood fiberboard serving as the central core and an overlay providing resistance to wear and abrasion.
