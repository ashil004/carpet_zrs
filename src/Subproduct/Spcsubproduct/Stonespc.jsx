...
const Stonespc = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/qx7kJ5S/banner-image-MVY0-MGMw-WGpr-Yn-ZINWt-CLz-Ni-VS80-Zz09.webp)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >Stone Spc Flooring</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className="m-4 ">
                <h3 className="text-3xl font-semibold ">Stone Spc Flooring</h3>
                <p className="text-lg mt-2" >You have a ton of leeway to create the pattern and arrangement you want thanks to the wide choice of designs available. If you like to take chances, have fun mixing and matching various colors to achieve your preferred style. Just let your imagination run free. That SPC flooring can withstand high traffic activity better than other types of flooring should not come as a surprise. In fact, this characteristic is a big part of why SPC flooring is so well-liked. It can support heavy foot traffic, making it ideal for large families or energetic individuals. These SPCs are of the homogenous kind and exhibit exceptional resistance to surface damage and scratches.
