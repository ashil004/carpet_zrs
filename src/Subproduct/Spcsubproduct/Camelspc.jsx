...
const Camelspc = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/yp93Wkx/banner-imageb2-Ra-OHd-SZTZ4-ZTh2-NHp-FOWN2-L09-Idz09.webp)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >Camel Spc Flooring</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className="m-4 ">
                <h3 className="text-3xl font-semibold ">Camel Spc Flooring</h3>
                <p className="text-lg" >Camel Spc Flooring is a Stone Plastic Composite (SPC) flooring that has a core typically constructed of polyvinyl chloride, plasticizers, and 60% calcium carbonate (limestone). Similar to WPC, this floor has a stiff core, however it has a thinner core. It is still inherently water-resistant, though, so a second or third waterproofing layer is not necessary.
