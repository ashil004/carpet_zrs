...
const Spcaccessories = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/tm08rrT/banner-image-Wj-FQM3-FPNTBxe-U5yd-HQwd-VBINn-Bw-UT09-1.webp)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >Spc Flooring Accessories</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className="m-4 ">
                <h3 className="text-3xl font-semibold ">Spc Flooring Accessories</h3>
                <p className="text-lg mt-2" >Higher Eva Spc Flooring is a firm core flooring that combines the durability of stone and the aesthetics of wood for a one-stop shop for interior design. UV coating, Wear layer, SPC print layer, SPC core, and Balanced layer make up SPC flooring. EVA, IXPE foam, or cork wood are available as alternatives for the backing. It has a number of benefits, such as strong dimensional stability, high peel strength, nearly no walking noise, no warping, no distortion, 100% watertight, heat and sound insulation, an environmentally favorable rigid floor, and no harmful emissions.
