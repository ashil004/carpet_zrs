...
const Herringbonespc = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/McFZYhw/banner-image-QUNXMHZw-Z2-Nkcm4ydnp5d-GNp-OFF5dz09-1.webp)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >Herringbone Spc Flooring</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className="m-4 ">
                <h3 className="text-3xl font-semibold ">Herringbone Spc Flooring</h3>
                <p className="text-lg mt-2" >The herringbone pattern got its name from its fictitious resemblance to the bones of this type of fish. Then it becomes one of the most often utilized floor tile designs in the world of rectangles. Many people adore its consistency, which is both aesthetically pleasant and gives space a sense of solidity. As a high-end flooring, it is a fantastic space changer that can work to simultaneously direct the gaze upward and outward. It can be used to embellish a sizable space, enhancing its splendor. It is a simple approach to give a flat or uninteresting environment a dynamic dimension. Herringbone SPC flooring can also be used with other forms of flooring, such ceramic tiles.
