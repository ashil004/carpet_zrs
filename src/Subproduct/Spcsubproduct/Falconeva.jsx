...
const Falconeva = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/vwTVfbs/banner-image-Ukh-BN0-JKdj-BLc1p-VMXJSWHFk-TWNKdz09.webp)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >Falcon Eva Spc Flooring</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className="m-4 ">
                <h3 className="text-3xl font-semibold ">Falcon Eva Spc Flooring</h3>
                <p className="text-lg" >The Falcon Floors - Nebula - 4.5mm SPC Luxury Vinyl Plank has a high-density core made of materials and high-resolution imaging on the surface, giving it the appearance of real wood while offering vinyl flooring's performance. This premium vinyl plank flooring is incredibly resilient and will increase the beauty and worth of your home while continuing to look brand new for many years. The stone plastic composite core, or SPC, keeps your floors structurally sound even in damp or hot environments and prevents them from denting when objects fall on them. Because of how adaptable these click vinyl floors are, you may install them in any room of the house, including the laundry room and bathrooms.
