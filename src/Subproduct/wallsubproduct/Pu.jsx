...
const Pu = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/nmq95r3/PU-Stone.webp)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >PU STONE</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className="m-4 ">
                <h3 className="text-3xl font-semibold ">PU STONE</h3>
                <p className="text-lg mt-2" >PU stone is a synthetic material that imitates the appearance and texture of natural stone. It is made of polyurethane, a type of polymer that can replace rubber, plastic, nylon, and other products. PU stone has many advantages over real stone, such as being lightweight, durable, economical, environment-friendly, and easy to install. PU stone can be used for interior and exterior wall decoration, landscaping, art, and other purposes. PU stone comes in various shapes and colors, such as Great Wall stone, tile board, flowing water stone, concrete cement board, mushroom stone, and stone skin. PU stone is a cross-border new material that applies familiar materials to restore the real stone decoration material..
                ...
                <div>
                    <div className="grid xl:grid-cols-3 xl:mx-6 lg:mx-4 md:mx-2 mx-0 gap-y-4 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 mt-4">
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/Nr3XzYL/p1.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Pu-Stone-01</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/6ZbM5zd/p2.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Pu-Stone-02</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/nrp0fCd/p3.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Pu-Stone-03</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/9pBn407/p4.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Pu-Stone-04</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/59WrX9x/p5.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Pu-Stone-05</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/8D8r9ct/p6.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Pu-Stone-06</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/6gy9WfY/p7.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Pu-Stone-07</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/0m5jTmP/p8.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Pu-Stone-08</h2>
