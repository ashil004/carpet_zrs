...
const Wpcco = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/nQHsF8Y/WPC-Co-Extrusion-Wall-Cladding-2.webp)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >WPC Co Extrusion Wall cladding</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className="m-4 ">
                <h3 className="text-3xl font-semibold ">WPC Co Extrusion Wall cladding</h3>
                <p className="text-lg mt-2" >Co-Extrusion A cutting-edge premium shield surrounds the inner core of the wall cladding on ALL four sides. There are no toxic adhesives or chemicals used because the shield and core are extruded simultaneously in a mold at a very high temperature. In order to increase strength and durability, the core is made of carefully chosen recycled materials and highly dense recycled hardwood and softwood fibers. Best of all, it is 100% recyclable. It has a longer lifespan than typical uncapped composites, requires less upkeep, and guards against mold and mildew.
                ...
                <div>
                    <div className="grid xl:grid-cols-3 xl:mx-6 lg:mx-4 md:mx-2 mx-0 gap-y-4 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 mt-4">
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/VSHS53v/1-1.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Wpc-co-extrusion-01</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/28Y1S6n/2-1.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Wpc-co-extrusion-02</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/WKH1XVc/3-1.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Wpc-co-extrusion-03</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/8NnDNCt/4-1.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Wpc-co-extrusion-04</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/XLpQrLd/5-1.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Wpc-co-extrusion-05</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/5W7wYcD/6-1.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Wpc-co-extrusion-06</h2>
