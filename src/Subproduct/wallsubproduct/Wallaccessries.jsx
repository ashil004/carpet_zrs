...
const Wallaccessries = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/C8RGMCf/Wall-Cladding-Accessories-2.webp)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >Wall Cladding Accessories</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className="m-4 ">
                <h3 className="text-3xl font-semibold ">Wall Cladding Accessories</h3>
                <p className="text-lg mt-2" >Just as important as selecting the proper roofing and wall cladding materials is choosing the appropriate accessories. We offer high-quality accents that not only go with our cladding material, but also work well with it. They guarantee lifespan, are waterproof from the elements and from leaks, and improve the building's appearance. Like infill strips or foam filler, which are specially designed infill strips made of closed-cell polyethylene form and placed between the support and the underlying roof sheeting. This creates a strong seal to prevent debris, insects, rodents, wind-driven rain, salt, and free embers from penetrating rib cavities.
                ...
                <div>
                    <div className="grid xl:grid-cols-3 xl:mx-6 lg:mx-4 md:mx-2 mx-0 gap-y-4 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 mt-4">
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/zhYNHyn/1-2.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Wall-Accessories-01</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/MC3WjdT/2-2.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Wall-Accessories-02</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/JxNF0g4/3-2.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Wall-Accessories-03</h2>
