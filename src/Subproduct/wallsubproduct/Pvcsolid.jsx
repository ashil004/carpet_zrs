...
const Pvcsolid = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/X7YRvdG/PVC-Solid-Wall-Cladding.webp)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >PVC Solid Wall Cladding</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className="m-4 ">
                <h3 className="text-3xl font-semibold ">PVC Solid Wall Cladding</h3>
                <p className="text-lg mt-2" >By using the newest interior design ideas, many people try to make their homes appear chic and contemporary. Wallpaper, tile cladding, and paint have all been displaced by the interior wall paneling trend. The most common wall panel is PVC Solid Wall Cladding. They can be used to enhance the look of your interiors, including the flooring and furniture. Due to their many benefits, such as flexibility, impact resistance, and durability, PVC Solid Wall Cladding are a highly sought-after green product. These panels are reasonably priced and lightweight.
                ...
                <div>
                    <div className="grid xl:grid-cols-3 xl:mx-6 lg:mx-4 md:mx-2 mx-0 gap-y-4 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 mt-4">
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/8YLf8mM/1-6.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Pvc-Solid-01</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/1RsJv24/2-6.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Pvc-Solid-02</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/qRr28Yw/3-6.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Pvc-Solid-03</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/mHFbvzY/4-5.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Pvc-Solid-04</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/56BJnfy/5-6.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Pvc-Solid-05</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/V9tjfQr/6-5.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Pvc-Solid-06</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/zsV8LyJ/7-4.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Pvc-Solid-07</h2>
                        ...
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/kJ40ZW0/8-2.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Pvc-Solid-08</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co/rb7wcg7/9-2.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Pvc-Solid-09</h2>
