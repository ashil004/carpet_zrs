...
const Wetmat = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/Y3x50mg/banner-imagec-Wdu-Kz-R1-MVRlcm9ha3-RRQl-VVQzl-UZz09.webp)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold text-black" >Wet Mat Flooring</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className="m-4 ">
                <h3 className="text-3xl font-semibold ">Wet Mat Flooring</h3>
                <p className="text-lg" >There are several uses for wet area floor mats. By increasing friction, they not only improve a pedestrian's footing but also wipe the pedestrian's feet, preventing wet and debris from being tracked throughout your institution and causing issues in other places. Keep in mind that floor mats must be level and in good condition. Even by itself, a torn or crumpled mat poses a fall risk. As a result, mats must be changed frequently. Z&S Carpets' wet mat helps prevent this.
