...
const Pvcmat = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/YBy9LFL/banner-image-WDZLWW1-Ba-TJTc-HRCMG5-FWl-Jv-ODhpdz09-1.jpg)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold text-black" >PVC Mat</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className="m-4 ">
                <h3 className="text-3xl font-semibold ">PVC Mat</h3>
                <p className="text-lg" >Traditional carpets have been employed to offer your property a distinctive appearance in the past. But because they were heavy and difficult to clean, they required a lot of upkeep. PVC, which stands for polyvinyl chloride, has long been regarded as the most adaptable kind of flooring. PVC floor mat has grown in popularity among people due to its adaptability. People are choosing PVC floor mats to be fitted in their homes as well as offices. Many of the benefits associated with its installation have contributed to its popularity. The following are the key elements that should be taken into account before installing PVC floor mats: durability, ease of installation, cost effectiveness, and low maintenance. Etc
