...
const Clearpvc = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/SRX7CYc/banner-image-Yn-Fn-WTU4-OW12-N0-Mvdj-BORUJ4-Qjl1-QT09.webp)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >Clear PVC</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className="m-4 ">
                <h3 className="text-3xl font-semibold ">Clear PVC</h3>
                <p className="text-lg" >Only surfaces with HARD FLOORS are intended for clear PVC. They are intended to stay firmly in place while in use thanks to their transparent surface and anti-slip coating on the bottom. Please place the rough side up and the smooth side down. This PVC clear mat is very flexible and has been proven to reduce leg fatigue by relieving pressure on your legs. It is also ergonomically designed to provide added ease of movement. This aids in preventing caster or wheel wear on your office chair from damaging hard flooring. Will not crack, curl, break, scrape, or change color with normal use. mostly used as a chair mat and a wood floor cover. suitable for hard floors like as concrete, laminate, wood, stone, vinyl, and tile.
