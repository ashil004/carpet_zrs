...
const Coilmat = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/f96Pny8/banner-imageb-VBJNmx6ak1-GUVBEYU9-YTUVNYj-RBQT09-1.jpg)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >SPVC / Coil Mat</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className="m-4 ">
                <h3 className="text-3xl font-semibold ">SPVC / Coil Mat</h3>
                <p className="text-lg" >The substance is resilient and spongy. As opposed to Mainland Chinese harsh and stiff finishing kinds, which were made from recycled materials. 1. Simple to maintain and clean - Dirt or debris will be trapped in the mat by our special coil's dry surface until you are ready to vacuum or shake it off. Our PVC coil mat shields damp surfaces like wet grass and sand in addition to shielding your car from spills and stains. The dense padding of our protector ensures comfort even on hard surfaces and uneven terrain.
