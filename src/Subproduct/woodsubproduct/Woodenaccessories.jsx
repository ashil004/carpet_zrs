...
const Woodenaccessories = () => {
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co.com/6FtHRtj/Wood-Flooring-Accessories.webp)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >Wooden Flooring Accessories</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className=" w-[98%] mx-auto  ">
                <h3 className="text-3xl font-semibold ">Wooden Flooring Accessories</h3>
                <p className="text-lg" >Wood flooring has become very common in both residential and business settings because of its opulent, alluring, and chic appeal. Warm textures, vibrant hues, and robust durability offer a firm and long-lasting foundation. A few accessories are necessary for proper wood floor installation in order to guarantee a flawless surface and longevity. To stop dirt and dust from gathering under the floor, veneered skirting is used to conceal the gaps between the flooring and walls. One of the most crucial wood flooring accents, beadings fill the space between the floor and the wall to keep the latter looking tidy and clean. Edge moulding aids in the floors' natural expansion and contraction when they touch immovable things like a door casing.
                ...
                <div>
                    <div className="grid xl:grid-cols-3 xl:mx-6 lg:mx-4 md:mx-2 mx-0 gap-y-4 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 mt-4">
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co.com/LQWS20h/1-11.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Wooden-Accessories-01</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co.com/8PWmPDM/2-11.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Wooden-Accessories-02</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co.com/cXzZvVw/3-11.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Wooden-Accessories-03</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co.com/mbbK5x3/4-9.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Wooden-Accessories-04</h2>
