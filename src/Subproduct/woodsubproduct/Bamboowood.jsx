...
const Bamboowood = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co.com/T8s2B87/Bamboo-Flooring.webp)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >Bamboo Flooring</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className="m-4 ">
                <h3 className="text-3xl font-semibold ">Bamboo Flooring</h3>
                <p className="text-lg" >Recently, bamboo flooring has drawn increased attention, especially from homeowners looking for sustainable and eco-friendly building materials. Bamboo flooring is affordable compared to other common floor options, easy to install and maintain, and gives a contemporary and natural aesthetic that may increase a home's real estate value. Bamboo stalks may be harvested five to six times per year, making them far more sustainable than trees.
                ...
                <div>
                    <div className="grid xl:grid-cols-3 xl:mx-6 lg:mx-4 md:mx-2 mx-0 gap-y-4 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 mt-4">
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co.com/RTQKk7b/1-10.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Bamboo-01</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co.com/jT18m9P/2-10.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Bamboo-02</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co.com/T0Tj1tm/3-10.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Bamboo-03</h2>
