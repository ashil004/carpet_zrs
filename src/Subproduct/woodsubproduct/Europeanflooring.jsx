...
const Europeanflooring = () => {
    ...
    return (
        ...
        <div>
            <div className="-mt-24">
                <div className="h-[60vh] mt-24 bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co.com/2jZWLYh/European-Engineered-wood-flooring.webp)', }}>
                    <div className="hero-overlay opacity-0"></div>
                    <div className="  text-white -mt-56 ml-12 ">
                        <h1 className="text-3xl font-bold" >European Engineered Wood Flooring</h1>
        ...
        <div className=" xl:w-80 xl:h-[800px] lg:w-64 lg:h-[520px] md:w-64 md:h-[520px] w-20 h-[520px] bg-white shadow-xl border border-black text-black  rounded-lg bg-fixed  px-6">
            ...
            <div className="w-[98%] mx-auto  ">
                <h3 className="text-3xl font-semibold ">European Engineered Wood Flooring</h3>
                <p className="text-lg" >It is generally known that European Engineered Wood Flooring is a very high grade oak species with very low sap, which makes it a wonderful choice for your next wood flooring project. European Engineered Wood Flooring's overall appearance and quality are influenced by a number of elements, including the size of the boards (thickness, width, and length), the stain color, the type of finish, and the number of coats of finish used.
                ...
                <div>
                    <div className="grid xl:grid-cols-3 xl:mx-6 lg:mx-4 md:mx-2 mx-0 gap-y-4 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 mt-4">
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co.com/bz9BjwC/1-9.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">European-Wood-01</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co.com/rvt9xMS/2-9.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">European-Wood-02</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co.com/RBrmKL0/3-9.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">European-Wood-03</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co.com/fHnnBxz/4-8.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">European-Wood-04</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co.com/7Qqqhz3/5-9.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">European-Wood-05</h2>


                            </div>
                        </div>
                        <div className="card xl:w-80 lg:w-64 md:w-48 w-56  bg-white shadow-xl">
                            <figure><img src="https://i.ibb.co.com/StBKsjS/6-7.webp" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">European-Wood-06</h2>
...
export default Europeanflooring;