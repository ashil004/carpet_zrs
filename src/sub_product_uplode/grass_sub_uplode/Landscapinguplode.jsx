    ...
    return (
        ...
        <form onSubmit={subproduct} >
            <div className="form-control">
                ...
                <input type="text" name='title' placeholder="Enter Your Product title" className="input input-bordered w-[250px] md:w-[500px]" required />
            </div>
            <div className="form-control">
                <label className="label">
...
export default Landscapinguplode;