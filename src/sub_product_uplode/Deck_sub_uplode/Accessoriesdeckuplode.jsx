...
const Accessoriesdeckuplode = () => {
    ...
    return (
        ...
        <h3 className="text-center text-xl font-semibold text-lime-500">Deck Flooring Accessories</h3>
...
export default Accessoriesdeckuplode;