...
const Woodaccessoriesuplod = () => {
    ...
    return (
        ...
        <h3 className="text-center text-xl font-semibold text-lime-500">Wooden Flooring Accessories</h3>
...
export default Woodaccessoriesuplod;