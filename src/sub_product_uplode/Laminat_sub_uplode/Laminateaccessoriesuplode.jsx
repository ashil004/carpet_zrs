...
const Laminateaccessoriesuplode = () => {
    ...
    return (
        ...
        <h3 className="text-center text-xl font-semibold text-lime-500"> Laminate Flooring Accessories</h3>
...
export default Laminateaccessoriesuplode;